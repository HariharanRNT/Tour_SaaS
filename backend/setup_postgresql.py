"""Script to setup PostgreSQL database"""
import os
...
# Database (PostgreSQL)
DATABASE_URL=postgresql+asyncpg://postgres:postgres@localhost:5432/tour_saas
...
print("[OK] .env file updated with PostgreSQL configuration!")
print("\nPostgreSQL Configuration:")
print("  Host: localhost")
print("  Port: 5432")
print("  Database: tour_saas")
print("  Username: postgres")
print("  Password: postgres")
print("\nNOTE: Update the password in .env if your PostgreSQL password is different")
