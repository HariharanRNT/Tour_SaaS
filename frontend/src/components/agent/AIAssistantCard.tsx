                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            ...
                            className="w-[340px] max-h-[480px] rounded-[24px] overflow-hidden flex flex-col border border-white/25 shadow-[0_8px_32px_var(--primary-glow)] pointer-events-auto"
                            style={{
                        ...
                        >
                            {/* Header */}
                            <div className="p-4 flex items-center justify-between border-b border-white/10 bg-gradient-to-r from-[var(--primary)]/10 to-[var(--primary-light)]/10">
                                <div className="flex items-center gap-2.5">
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[var(--primary)] to-[var(--primary-light)] flex items-center justify-center shadow-lg shadow-[var(--primary-glow)]">
                                ...
                                <div className="space-y-3 pt-2">
                                    <div className="relative">
                                        <Input
                                            ...
                                            className="bg-white/40 border-white/40 rounded-full pl-4 pr-10 focus:ring-[var(--primary)] focus:border-[var(--primary)] text-sm h-11 placeholder:text-slate-400"
                                        />
                                        <button
                                            onClick={handleSend}
                                            disabled={!message.trim() || isLoading}
                                            className="absolute right-1.5 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-[var(--primary)] flex items-center justify-center text-white disabled:opacity-50 transition-transform active:scale-90"
                                        >
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {suggestions.map((suggestion, i) => (
                                            <button
                                                ...
                                                className="px-3 py-1.5 bg-[var(--primary-light)]/20 hover:bg-[var(--primary-light)]/40 text-[var(--primary)] text-[10px] font-bold rounded-full border border-[var(--primary-light)]/30 transition-colors"
                                            >
                                                {suggestion}
                                            </button>
                                        ))}
                            ...
                            <div className="absolute -z-10 bottom-0 right-0 w-32 h-32 bg-[var(--primary)]/5 blur-3xl rounded-full pointer-events-none" />
                        </motion.div>
                    )}
                </AnimatePresence>
            </div>
