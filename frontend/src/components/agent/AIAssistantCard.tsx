            ...
            <AnimatePresence>
                {!isOpen ? (
                    <motion.button
                        ...
                        className="relative w-14 h-14 rounded-full flex items-center justify-center overflow-hidden shadow-[0_8px_32px_rgba(255,122,69,0.35)] group"
                        style={{
                    ...
                    >
                        ...
                        <Sparkles className="relative z-10 text-white h-7 w-7 group-hover:rotate-12 transition-transform duration-300" />
                    </motion.button>
                ) : (
                    <motion.div
                        key="card"
                        ...
                        className="w-[340px] max-h-[480px] rounded-[24px] overflow-hidden flex flex-col border border-white/25 shadow-[0_8px_32px_rgba(255,122,69,0.25)]"
                        style={{
