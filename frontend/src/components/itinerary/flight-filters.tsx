        ...
        <div className="space-y-6 p-4 bg-white/10 backdrop-blur-md rounded-2xl border border-white/10 shadow-sm">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                filters.timeRanges.includes(opt.id)
                                    ...
                                    : "border-white/20 bg-white/15 hover:bg-white/25 text-black font-bold hover:border-white/40"
                            )}
                        >
                            <opt.icon className="h-4 w-4 mb-1" />
                            <span>{opt.label}</span>
                            <span className="text-[10px] text-black font-black">{opt.sub}</span>
                        </button>
                    ))}
                </div>
            </div>
            ...
            <div className="space-y-3">
                ...
                {availableAirlines.length === 0 ? (
                    <p className="text-xs text-black font-bold">No airlines available for current selection</p>
                ) : (
