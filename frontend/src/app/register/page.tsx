...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-[300px] bg-gradient-to-b from-blue-50 to-transparent -z-10" />
            <div className="absolute top-20 right-20 w-64 h-64 bg-purple-100 rounded-full blur-[100px] opacity-40 -z-10" />
            <div className="absolute bottom-20 left-20 w-72 h-72 bg-blue-100 rounded-full blur-[100px] opacity-40 -z-10" />
                ...
                <Card className="shadow-2xl shadow-blue-900/5 border-0 rounded-[2rem] overflow-hidden bg-white/80 backdrop-blur-sm">
                    ...
                    <CardContent className="px-8 pb-8">
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <Button variant="outline" className="h-11 rounded-xl border-gray-200 hover:bg-gray-50 hover:text-gray-900 hover:border-gray-300 transition-all text-gray-600 font-medium text-sm">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <PhoneInput
                                        ...
                                        inputClass="!w-full !h-11 !pl-[48px] !text-sm !border-gray-200 !rounded-xl focus:!border-blue-500 focus:!ring-blue-500/20 !font-medium !transition-all"
                                        buttonClass="!border-gray-200 !rounded-l-xl !bg-gray-50/50 hover:!bg-gray-100 !transition-colors !px-1"
                    ...
                    <CardFooter className="bg-gray-50/50 border-t border-gray-100 py-4 flex justify-center">
