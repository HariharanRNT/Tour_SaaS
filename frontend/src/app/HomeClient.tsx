...
import { formatCurrency, formatDate, formatDuration, decodeHtmlEntities, resolveImageUrl } from '@/lib/utils'
import {
...
export default function HomeClient({ searchParams }: { searchParams: { site?: string } }) {
                        ...
                        <div className="max-w-7xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                                {packages.map((pkg, idx) => {
                                    ...
                                    const cardImage = pkg.feature_image_url ? resolveImageUrl(pkg.feature_image_url) : fallbackImages[idx % fallbackImages.length]
