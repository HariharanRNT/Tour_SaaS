        ...
        <RoleGuard allowedRoles={['agent', 'AGENT']}>
            <SubscriptionGuard>
                ...
                <div className="fixed inset-0 z-0 pointer-events-none">
                    <div className="absolute top-0 right-0 w-[60%] h-[60%] bg-gradient-radial from-[var(--primary-soft)]/60 to-transparent rounded-full blur-[100px]" />
                    <div className="absolute bottom-0 left-0 w-[50%] h-[50%] bg-gradient-radial from-[var(--primary-light)]/40 to-transparent rounded-full blur-[100px]" />
