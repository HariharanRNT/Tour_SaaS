...
export const MASTER_SHELLS: Record<EmailTemplateType, (content: StructuredEmailContent) => string> = {
        ...
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; background: white;">
            ...
            <div style="padding: 30px; color: #334155;">
                ...
                <div style="background-color: #f8fafc; border-radius: 8px; padding: 20px; margin: 25px 0; border: 1px solid #f1f5f9;">
                    <h2 data-edit="details_title" style="margin-top: 0; font-size: 16px; color: #1e293b;">${c.details_title}</h2>
    ...
    travel_itinerary: (c) => `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; background: white;">
            ...
            <div style="padding: 30px; color: #334155;">
                ...
                <p data-edit="closing_text" style="font-weight: bold; color: #1e293b;">${c.closing_text}</p>
    ...
    booking_invoice: (c) => `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; padding: 40px; background: white;">
            <table style="width: 100%; border-bottom: 2px solid #1e293b; padding-bottom: 20px; margin-bottom: 30px;">
                <tr>
                    <td><h1 data-edit="invoice_title" style="margin: 0; color: #1e293b; font-size: 28px;">${c.invoice_title}</h1></td>
            ...
            <div style="margin-bottom: 30px;">
                <p data-edit="bill_to_label" style="color: #64748b; margin-bottom: 5px; font-size: 13px;">${c.bill_to_label}</p>
            ...
            <p data-edit="attachment_note" style="font-size: 13px; color: #64748b; margin-top: 40px;">${c.attachment_note}</p>
        </div>
    `.trim(),
    ...
    payment_receipt: (c) => `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; background-color: white; padding: 40px; color: #334155;">
            <p data-edit="hero_title" style="margin-top: 0; font-size: 16px;">${c.hero_title}</p>
            <p data-edit="intro_text" style="line-height: 1.6; margin-bottom: 25px; white-space: pre-line;">${c.intro_text}</p>
            
            <hr style="border: 0; border-top: 1px solid #f1f5f9; margin: 25px 0;">
            
            <h3 data-edit="details_title" style="color: #1e293b; font-size: 17px; margin-bottom: 15px; display: flex; align-items: center;">${c.details_title}</h3>
            ...
            <h3 data-edit="invoice_note_title" style="color: #1e293b; font-size: 17px; margin-bottom: 10px;">${c.invoice_note_title}</h3>
            ...
            <h3 data-edit="important_note_title" style="color: #1e293b; font-size: 17px; margin-bottom: 10px;">${c.important_note_title}</h3>
            <p data-edit="important_note_text" style="font-size: 14px; line-height: 1.6; margin-bottom: 25px; color: #64748b;">${c.important_note_text}</p>
    ...
    booking_cancellation: (c) => `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #fee2e2; border-top: 4px solid #ef4444; padding: 30px; background: white;">
            <h1 data-edit="hero_title" style="color: #991b1b; margin-top: 0; font-size: 24px;">${c.hero_title}</h1>
    ...
    trip_reminder: (c) => `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background-color: #eff6ff; border-radius: 12px; padding: 40px; text-align: center;">
            ...
            <p data-edit="footer_note" style="font-size: 12px; color: #64748b;">${c.footer_note}</p>
        </div>
    `.trim()
};
